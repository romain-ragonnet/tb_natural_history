...
# pars=list('gamma'=0.1226141 , 'mu'=1/55, 'mu_t'=0.2210784)  # best LL for smear-positive
...
analysis$run_metropolis(model = 2,n_iterations = 1000, n_burned = 50,smear_status = c('positive'))
...
outputs$produce_mcmc_outputs(model = 2, smear_status = c('positive'))
